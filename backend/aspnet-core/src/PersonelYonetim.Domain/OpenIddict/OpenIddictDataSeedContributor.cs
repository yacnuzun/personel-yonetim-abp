...
namespace PersonelYonetim.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("PersonelYonetim") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "PersonelYonetim", DisplayName = "PersonelYonetim API", Resources = { "PersonelYonetim" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["PersonelYonetim_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["PersonelYonetim_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        // Angular Client
        var angularClientId = "PersonelYonetim_App";
        if (await _openIddictApplicationRepository.FindByClientIdAsync(angularClientId) == null)
        {
            await CreateApplicationAsync(
