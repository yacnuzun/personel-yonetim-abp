...
public class PersonelYonetimDbContext :
    AbpDbContext<PersonelYonetimDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public PersonelYonetimDbContext(DbContextOptions<PersonelYonetimDbContext> options)
        : base(options)
    {
